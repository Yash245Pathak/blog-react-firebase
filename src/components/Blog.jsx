...
function Blog() {
    ...
    return (
        <>
            {blogList.map((blog) => {
                const paraShort = blog.para.substr(0, 150) + "...";
                return (
                        ...
                        <div className='shadow-2xl p-5'>
                            <div className='px-2'>
                                <div className='flex flex-col gap-4 mt-6 text-center md:text-left'>
                                    ...
                                    <p className='text-[1rem] md:text-[1rem] font-thin leading-tight'>{paraShort}</p>
                                </div>
                                <div className='flex justify-between mt-4'>
                                    <button className='btn-pill-sm capitalize'><Link to={`/singleblog/${blog.id}`}>Read more</Link></button>
                                </div>
